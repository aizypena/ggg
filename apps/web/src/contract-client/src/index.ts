...
export type DataKey =
  | { tag: "Organizer"; values: void }
  | { tag: "Referee"; values: void }
  | { tag: "Token"; values: void }
  | { tag: "EntryFee"; values: void }
  | { tag: "DistributionBps"; values: void }
  | { tag: "Players"; values: void }
...
export class Client extends ContractClient {
  ...
  constructor(public override readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "",
